/**
 * @file
 * Forked from core's autocomplete. This is copied from the rules module.
 */
...
(function ($, Drupal) {
  ...
  function selectHandler(event, ui) {
    ...
    if (input_value.substr(input_value.length - 1) === '.' || input_value.substr(input_value.length - 1) === ':') {
  ...
  Drupal.behaviors.rules_autocomplete = {
    ...
    detach: function (context, settings, trigger) {
      if (trigger === 'unload') {
        $(context).find('input.property_path-autocomplete')
