 ...
 *     "delete-form" = "/print-article/{print_article}/delete",
 *     "delete-multiple-form" = "/print-article/delete",
 *     "version-history" = "/print-article/{print_article}/revisions",
 *     "revision" = "/print-article/{print_article}/revisions/{print_article_revision}/view",
