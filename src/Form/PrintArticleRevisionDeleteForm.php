...
/**
 * Provides a form for deleting a Print article revision.
 *
 * @ingroup thunder_print
 */
class PrintArticleRevisionDeleteForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new PrintArticleRevisionDeleteForm.
   *
  ...
  public static function create(ContainerInterface $container) {
    ...
    return new static(
      $entity_manager->getStorage('print_article'),
  ...
  public function getFormId() {
    return 'print_article_revision_delete_confirm';
  }
